...
public class EditVersionActivity extends AppCompatActivity
{
    ...
    private void askRecordAudioPermission() { ActivityCompat.requestPermissions(EditVersionActivity.this, new String[] {Manifest.permission.RECORD_AUDIO}, REQUEST_CODE); }
